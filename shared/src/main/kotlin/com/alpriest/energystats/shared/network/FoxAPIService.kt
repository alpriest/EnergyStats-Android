...
import com.alpriest.energystats.shared.models.network.ErrorMessagesResponse
import com.alpriest.energystats.shared.models.network.FetchDeviceSettingsItemRequest
...
import com.alpriest.energystats.shared.models.network.OpenReportRequest
import com.alpriest.energystats.shared.models.network.OpenReportResponse
import com.alpriest.energystats.shared.models.network.PagedDataLoggerListResponse
import com.alpriest.energystats.shared.models.network.PagedDeviceListResponse
...
class FoxAPIService(private val requestData: RequestData, interceptor: Interceptor? = null) : FoxAPIServicing {
    ...
    override suspend fun openapi_fetchSchedulerFlag(deviceSN: String): GetSchedulerFlagResponse {
        ...
        val response: NetworkTuple<NetworkResponse<GetSchedulerFlagResponse>> = fetchJSON(request)
        return response.item.result ?: throw MissingDataException()
    }
