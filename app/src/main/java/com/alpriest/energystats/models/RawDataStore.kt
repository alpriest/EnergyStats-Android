...
class RawDataStore : RawDataStoring {
    ...
    override var batterySettingsStream: MutableStateFlow<BatterySOCResponse?> = MutableStateFlow(null)
    ...
    override fun store(batterySettings: BatterySOCResponse) = run { batterySettingsStream.value = batterySettings }
