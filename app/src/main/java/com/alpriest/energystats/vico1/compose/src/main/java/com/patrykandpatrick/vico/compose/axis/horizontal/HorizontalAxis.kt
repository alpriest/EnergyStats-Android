...
package com.patrykandpatrick.vico1.compose.axis.horizontal
...
import com.patrykandpatrick.vico1.compose.axis.axisLineComponent
import com.patrykandpatrick.vico1.compose.axis.axisTickComponent
...
import com.patrykandpatrick.vico1.core.axis.horizontal.createHorizontalAxis
...
@Deprecated(
    ...
    ReplaceWith(
        ...
        """,
        "com.patrykandpatrick.vico1.compose.axis.horizontal.rememberTopAxis",
    ),
)
public fun topAxis(
    label: TextComponent? = axisLabelComponent(),
...
@Deprecated(
    ...
    ReplaceWith(
        ...
        """,
        "com.patrykandpatrick.vico1.compose.axis.horizontal.rememberBottomAxis",
    ),
)
...
@Deprecated(
    ...
    ReplaceWith(
        ...
        "com.patrykandpatrick.vico1.compose.axis.horizontal.rememberTopAxis",
        "com.patrykandpatrick.vico1.core.axis.AxisItemPlacer",
    ),
)
public fun topAxis(
    label: TextComponent? = axisLabelComponent(),
