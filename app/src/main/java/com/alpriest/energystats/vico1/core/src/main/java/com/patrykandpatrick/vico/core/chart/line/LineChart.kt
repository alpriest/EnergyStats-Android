...
package com.patrykandpatrick.vico1.core.chart.line
...
import com.patrykandpatrick.vico1.core.chart.BaseChart
import com.patrykandpatrick.vico1.core.chart.Chart
import com.patrykandpatrick.vico1.core.chart.DefaultPointConnector
import com.patrykandpatrick.vico1.core.chart.composed.ComposedChart
import com.patrykandpatrick.vico1.core.chart.dimensions.HorizontalDimensions
...
import com.patrykandpatrick.vico1.core.chart.forEachInIndexed
import com.patrykandpatrick.vico1.core.chart.insets.Insets
import com.patrykandpatrick.vico1.core.chart.layout.HorizontalLayout
import com.patrykandpatrick.vico1.core.chart.line.LineChart.LineSpec
import com.patrykandpatrick.vico1.core.chart.line.LineChart.LineSpec.PointConnector
import com.patrykandpatrick.vico1.core.chart.put
...
import com.patrykandpatrick.vico1.core.component.Component
import com.patrykandpatrick.vico1.core.component.shape.shader.DynamicShader
import com.patrykandpatrick.vico1.core.component.text.TextComponent
import com.patrykandpatrick.vico1.core.component.text.VerticalPosition
import com.patrykandpatrick.vico1.core.component.text.inBounds
import com.patrykandpatrick.vico1.core.context.DrawContext
import com.patrykandpatrick.vico1.core.context.MeasureContext
import com.patrykandpatrick.vico1.core.entry.ChartEntry
import com.patrykandpatrick.vico1.core.entry.ChartEntryModel
import com.patrykandpatrick.vico1.core.entry.diff.DefaultDrawingModelInterpolator
import com.patrykandpatrick.vico1.core.entry.diff.DrawingModelInterpolator
import com.patrykandpatrick.vico1.core.entry.diff.ExtraStore
...
import com.patrykandpatrick.vico1.core.extension.getRepeating
import com.patrykandpatrick.vico1.core.extension.getStart
import com.patrykandpatrick.vico1.core.extension.half
import com.patrykandpatrick.vico1.core.extension.withOpacity
import com.patrykandpatrick.vico1.core.formatter.DecimalFormatValueFormatter
import com.patrykandpatrick.vico1.core.formatter.ValueFormatter
    ...
    public open class LineSpec(
        ...
        @Deprecated(
            ...
            replaceWith = ReplaceWith(
                ...
                imports = arrayOf("com.patrykandpatrick.vico1.core.chart.DefaultPointConnector"),
            ),
